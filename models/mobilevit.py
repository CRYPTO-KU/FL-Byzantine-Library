...
def mobile_vit_xxs(image_size, num_classes):
    return MobileViT(image_size, 'xx_small', num_classes)

def mobile_vit_xs(image_size, num_classes):
    return MobileViT(image_size, 'x_small', num_classes)

def mobile_vit_s(image_size, num_classes):
    return MobileViT(image_size, 'small', num_classes)

if __name__ == '__main__':
    model = mobile_vit_xxs(224,10)
